...
public class FButton extends Button implements View.OnTouchListener {
    ...
    private void init() {
        ...
        if (resources == null)
            return;
        mButtonColor = resources.getColor(R.color.fbutton_default);
        mShadowColor = resources.getColor(R.color.fbutton_default_shadow);
